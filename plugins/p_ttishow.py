    ...
    if temp.ME in r_j_check:
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/81eae748a135e00edddcb.mp4",                                               
                                                 caption=f'<b>ʜᴇʏ, {u.mention} 👋🏻\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴏᴜʀ ɢʀᴏᴜᴘ {message.chat.title}\n\nʏᴏᴜ ᴄᴀɴ ꜰɪɴᴅ ᴍᴏᴠɪᴇꜱ / ꜱᴇʀɪᴇꜱ / ᴀɴɪᴍᴇꜱ ᴇᴛᴄ. ꜰʀᴏᴍ ʜᴇʀᴇ. ᴇɴᴊᴏʏ😉.\n\n<b>┏≫ ғᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇs</b>\n┣ <b>ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ›› @Star_X_Network</b></code>\n<b>┗≫ ғᴏʟʟᴏᴡ ɢʀᴏᴜᴘ ʀᴜʟᴇs</b>',
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚡ 𝙼𝙾𝚅𝙸𝙴𝚂 ⚡', url=f'https://t.me/Star_MoviesHub'),]])
                )
